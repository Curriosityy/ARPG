...
protected:
	static void GrantAbility(const TSubclassOf<UARPGGameplayAbility>& Ability, UARPGAbilitySystemComponent* InASC,
	                         int32 Level = 1);
	static void GrantAbilities(TArray<TSubclassOf<UARPGGameplayAbility>>& AbilitiesToGrant,
	                           UARPGAbilitySystemComponent* InASC, int32 Level = 1);
